package com.c.rabbit.upload;

import com.c.rabbit.download.task.TaskState;
import com.c.rabbit.upload.bean.UpLoadTaskInfo;
import com.c.rabbit.download.itask.ITaskInfo;
import com.c.rabbit.download.task.Task;
import com.c.rabbit.upload.http.UploadHttpAction;

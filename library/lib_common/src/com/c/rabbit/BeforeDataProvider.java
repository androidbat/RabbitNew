...
import com.c.rabbit.bean.ImageNetParaed;
...
import com.c.rabbit.my_cache_task.CacheTask;
import com.c.rabbit.my_cache_task.CacheTask.VisitCacheListener;
import com.c.rabbit.mycache.MyCacheManager;
import com.c.rabbit.net.HttpRequestFactory;
import com.c.rabbit.net.http.IHttpTask;
import com.c.rabbit.net.ihttp.HttpConnectionListener;
...
//	public static int currentPos=0;
    ...
    public void getImage(ImageView imageView,Bitmap mLoadingBitmap,ImgParas imgParas){
    	getImage(imgParas.url,mLoadingBitmap,imageView);
    }
